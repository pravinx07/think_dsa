...
export const mockUser = {
  ...
  hintsUsed: 23,
  joinedAt: '2024-01-15',
  hasActivity: true, // set false to see empty state
}
...
export const mockRecommendedProblems = [
  {
    id: 1,
  ...
  },
  {
    ...
    reason: 'Build new pattern skills',
    emoji: '🔄',
  },
  {
    id: 3,
    ...
    reason: 'Reinforce your strength',
    emoji: '🪟',
  },
]
...
export const mockRecentActivity = [
  ...
  },
  {
    ...
    timeSpent: '28 min',
    date: 'Yesterday',
    mistake: 'Off-by-one in window boundary',
  },
  {
    id: 3,
    title: 'Clone Graph',
    ...
    timeSpent: '45 min',
    date: '2 days ago',
    mistake: 'Forgot visited set for cycle detection',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    timeSpent: '40 min',
    date: '4 days ago',
    mistake: 'Subproblem definition unclear',
  },
]

export const mockWeaknessInsights = [
...
export const mockMentorMessages = [
  {
    ...
    content: "Hey Ajay! 👋 I've analyzed your progress. You're strong at Sliding Window (80%) and Arrays. Your main growth area right now is **Dynamic Programming** — you've only solved 4 DP problems. Want to work on that?",
  },
]

export const mockMentorSuggestions = [
  'Why am I bad at DP?',
